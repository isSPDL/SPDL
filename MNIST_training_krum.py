...
def run(f):
    ...
    node=p2p.Node()
    # filename1 = "./log/20/krum/loss/" + "loss_" + str(node.PORT) + ".txt"
    # filename2 = "./log/20/krum/error/" + "Test_error_" + str(node.PORT) + ".txt"
    # filename3 = "./log/30/krum/time/" + "time_correspond" + str(node.PORT) + ".txt"
    # filename4 = "./log/30/krum/time/" + "time_compute" + str(node.PORT) + ".txt"
