...
import grpc_pb2
import torch
from grpc_pb2 import CompressionType
...
def deserialize_torch_tensor(serialized_tensor: grpc_pb2.Tensor) -> torch.Tensor:
...
#     grpc_pb2.Tensor = serialize_torch_tensor(tensor=torch.tensor(1.11))
#     print(grpc_pb2.Tensor)